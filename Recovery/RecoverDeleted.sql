...
DECLARE @Database_Name NVARCHAR(MAX) = 'ProductionSF_dev' --'DB_Name'
DECLARE @SchemaName_n_TableName NVARCHAR(Max) = 'dbo.location' --'Schema.tablename'
DECLARE @Date_From DATETIME='1/23/2019'
DECLARE @Date_To DATETIME ='1/25/2019'
