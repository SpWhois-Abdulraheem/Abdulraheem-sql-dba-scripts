...
/*
John - 04/20/2015
Run this script on a server currently sending database email.  It will create a script that you can then run on a new server.
Only thing you'll need to edit is the variable "@display_name". (Generally line #32.)  That will need to be set to reflect the new database/instance name.
Copy the code it creates & run it on the new server.
*/
